module github.com/yclw/mys_project/apps/api
...
require (
	...
	github.com/yclw/mys_project/pkg/common v0.0.0
	github.com/yclw/mys_project/pkg/protobuf v0.0.0
	github.com/yclw/mys_project/pkg/utils v0.0.0
